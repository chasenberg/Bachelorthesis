...
int main(int argc, char* argv[]) {
 ...
 epdf->Cat("obsTag").defineType("Bbar_S",-1);
  ...
  data->Print();
  epdf->Pdf("pdfExtend").getParameters(data)->readFromFile("/home/chasenberg/Repository/bachelor-template/ToyStudy/f_param.txt");
  epdf->Pdf("pdfExtend").getParameters(data)->writeToFile("/home/chasenberg/Repository/bachelor-template/ToyStudy/f_param.txt.new");
